...
export interface ApiItemListingItemListing extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['rent', 'sale']> &
      ...
      Attribute.DefaultTo<'sale'>;
    type: Attribute.Enumeration<['real estate', 'vehicle', 'other']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Attribute.DefaultTo<'real estate'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::item-listing.item-listing': ApiItemListingItemListing;
